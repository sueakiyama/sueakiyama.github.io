...
この編集ファイルを、ジャケット制作用に改変したのがこちらです。動画サイズを1500*1500に変更し、レイさんのイラストの配置を変えています。私は普段、ジャケット・アートワーク制作に [GIMP](https://www.gimp.org/) (画像編集ソフト) を使っているのですが、今回だけは [aviutl](https://spring-fragrance.mints.ne.jp/aviutl/) (動画編集ソフト) を利用してみました。
